(repository
  ...
  (package
    ...
    (url "processio.tgz")
    (size 15360)
    (checksum (md5 "f22030a348071d2f30bf8cd86ffb8e1a"))
    (library
      (name (snow processio))
  ...
  (package
    ...
    (url "zlib.tgz")
    (size 48640)
    (checksum (md5 "14f2afd546ffe20aae1f7af8ac649040"))
    (library
      (name (snow zlib))
      (path "snow/zlib.sld")
      (version "1.0.1")
  ...
  (package
    ...
    (url "random.tgz")
    (size 8192)
    (checksum (md5 "bd289f4a4d7d1fd34c31ab70162653b2"))
    (library
      (name (snow random))
  ...
  (package
    ...
    (url "input-parse.tgz")
    (size 15360)
    (checksum (md5 "ebcc58fed9793965edbd7f2d6c650ae3"))
    (library
