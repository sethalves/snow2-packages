    ...
    (let chunk ((i 0)
      ...
      (let* ((n (read-bytevector! buf in))
        ...
        (let lp ((j 0)
          ...
          ;; (write (list (string-pad (number->string a 16) 8 #\0)
          ;;              (string-pad (number->string b 16) 8 #\0)
          ;;              (string-pad (number->string c 16) 8 #\0)
          ;;              (string-pad (number->string d 16) 8 #\0)
          ;;              (string-pad (number->string e 16) 8 #\0)
          ;;              (string-pad (number->string f 16) 8 #\0)
          ;;              (string-pad (number->string g 16) 8 #\0)
          ;;              (string-pad (number->string h 16) 8 #\0)))
          ;; (newline)
            ...
            (cond
             ((< n 64)
              (if (>= n 56)
                  ...
                  ;; Done - add back in the hash inits and serialize.
                  ...
                  ;; return a bytevector rather than a string
                  (let ((a (u32+ a (vector-ref inits 0)))
                        (b (u32+ b (vector-ref inits 1)))
                        (c (u32+ c (vector-ref inits 2)))
                        (d (u32+ d (vector-ref inits 3)))
                        (e (u32+ e (vector-ref inits 4)))
                        (f (u32+ f (vector-ref inits 5)))
                        (g (u32+ g (vector-ref inits 6)))
                        (h (u32+ h #x5be0cd19)))
