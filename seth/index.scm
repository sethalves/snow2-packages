(repository
  ...
  (package
    ...
    (url "tar.tgz")
    (size 6656)
    (checksum (md5 "0450047c655c605d5f14f86f977ef29f"))
    (library
      (name (seth tar))
      (path "seth/tar.sld")
      (version "1.3")
  ...
  (package
    ...
    (url "snow2-utils.tgz")
    (size 133120)
    (checksum (md5 "1ab80cd4089f6403aca33a74d43c04e5"))
    (library
  ...
  (package
    ...
    (size 20992)
    (checksum (md5 "e9ba9c5a8240b2d725ec56e420b94e40"))
    (library
  ...
  (package
    ...
    (size 43520)
    (checksum (md5 "c740b47006d863b2f88fac881d9f5809"))
    (library
  ...
  (package
    ...
    (url "uri.tgz")
    (size 76800)
    (checksum (md5 "9b2adfe69062ec7fa5433643ce59adb4"))
    (library
      (name (seth uri))
      (path "seth/uri.sld")
      (version "1.0")
  ...
  (package
    ...
    (url "http.tgz")
    (size 29184)
    (checksum (md5 "1ef66b328ab6a559c4a311d152311b11"))
    (library
      (name (seth http))
      (path "seth/http.sld")
      (version "1.0")
