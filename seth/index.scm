(repository
  ...
  (package
    ...
    (url "binary-pack.tgz")
    (size 5143)
    (checksum (md5 "f15044acb0ee6b02798ded5587ecf45f"))
    (library
  ...
  (package
    ...
    (url "port-extras.tgz")
    (size 7191)
    (checksum (md5 "2b11e652eb0861078350f8272f171845"))
    (library
  ...
  (package
    ...
    (url "aws.tgz")
    (size 19991)
    (checksum (md5 "f5a561239d164c2df4614f67ea51f74a"))
    (library
      (name (seth aws s3))
  ...
  (package
    ...
    (url "xml.tgz")
    (size 429109)
    (checksum (md5 "dfa418e9ccb7496b1d5c96bc8c12f66c"))
    (library
      (name (seth xml ssax))
  ...
  (package
    ...
    (url "cout.tgz")
    (size 4119)
    (checksum (md5 "5248fa86eec37a08165ca3c35d190adf"))
    (library
      (name (seth cout))
      (path "seth/cout.sld")
      (version "1.0")
  ...
  (package
    ...
    (url "crypt.tgz")
    (size 52247)
    (checksum (md5 "b116a6637dee36bcb7781a84e99d4e82"))
    (library
      (name (seth crypt md5))
  ...
  (package
    ...
    (url "snow2-utils.tgz")
    (size 117788)
    (checksum (md5 "3605f295fba0d183b81972d86872f41c"))
    (library
  ...
  (package
    ...
    (url "uri.tgz")
    (size 46103)
    (checksum (md5 "6d010a605fbff051171cb4445ab28208"))
    (library
      (name (seth uri))
      (path "seth/uri.sld")
      (version "1.0")
